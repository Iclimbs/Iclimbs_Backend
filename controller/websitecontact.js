...
const webContactRouter = express.Router();
const { transporter } = require("../service/transporter");
webContactRouter.post("/new", async (req, res) => {
    try {
        ...
        `,
            ...
            transporter.sendMail(mailOptions, (error, info) => {
                if (error) {
                    ...
                    // Send status response to frontend
...
webContactRouter.get("/list", admin, async (req, res) => {
    try {
...
module.exports = { webContactRouter };
